...
All projects on Akka are limited to a maximum data storage size of 2TB. If you anticipate having more than 500GB of data in one project, please contact us at mailto:support@akka.io[] so that we can help optimize your data storage and performance. Changes are dependent on use case and business priority.
...
https://cloud.google.com/security/encryption-at-rest/default-encryption[Encryption at rest in Google Cloud, window="new"].
...
* Email us at mailto:support@akka.io[] to provide feedback or get help. One of our team will get back to you as soon as possible.
