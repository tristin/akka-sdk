= Troubleshooting
:page-aliases: reference:troubleshooting.adoc[]
...
We make frequent changes and updates to the Akka CLI to give you a great experience. Make sure that you're using at least the latest supported version ({akka-support-version}), and preferably the latest version.
...
* Supply your  xref:operations:container-registries.adoc#_a_private_container_registry[credentials], and validate that they are correct.
