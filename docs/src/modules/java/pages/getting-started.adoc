...
[source,java]
----
include::example$java-valueentity-counter/src/main/java/com/example/Main.java[tag=main]
----
...
[source,java]
----
include::example$java-valueentity-counter/src/main/java/com/example/CounterEntity.java[tags=declarations;increase;close]
----
...
[source,java]
----
include::example$java-valueentity-counter/src/main/java/com/example/Number.java[]
----
