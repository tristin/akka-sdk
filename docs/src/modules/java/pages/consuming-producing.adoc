...
.{sample-base-url}/event-sourced-counter/src/main/java/counter/application/CounterEventsConsumer.java[CounterEventsConsumer.java]
----
include::example$event-sourced-counter/src/main/java/counter/application/CounterEventsConsumer.java[tag=ese-consumer]
----
...
[source,java,indent=0]
.{sample-base-url}/event-sourced-counter/src/main/java/counter/application/CounterEventsTopicConsumer.java[CounterEventsTopicConsumer.java]
----
include::example$event-sourced-counter/src/main/java/counter/application/CounterEventsTopicConsumer.java[tags=topic-consumer]
----
...
[source,java]
.{sample-base-url}/event-sourced-counter/src/main/java/counter/application/RawBytesConsumer.java[RawBytesConsumer.java]
----
include::example$event-sourced-counter/src/main/java/counter/application/RawBytesConsumer.java[tag=class]
----
...
[source,java,indent=0]
.{sample-base-url}/event-sourced-counter/src/main/java/counter/application/CounterJournalToTopicConsumer.java[CounterJournalToTopicConsumer.java]
----
include::example$event-sourced-counter/src/main/java/counter/application/CounterJournalToTopicConsumer.java[tag=class]
----
...
[source,java,indent=0]
.{sample-base-url}/event-sourced-counter/src/main/java/counter/application/CounterJournalToTopicWithMetaConsumer.java[CounterJournalToTopicWithMetaConsumer.java]
----
include::example$event-sourced-counter/src/main/java/counter/application/CounterJournalToTopicWithMetaConsumer.java[tag=class]
----
...
[source,java]
.{sample-base-url}/event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[CounterIntegrationTest.java]
----
include::example$event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[tags=class;test-topic]
----
...
.{sample-base-url}/event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[CounterIntegrationTest.java]
----
include::example$event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[tags=eventing-config]
----
...
.{sample-base-url}/event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[CounterIntegrationTest.java]
----
include::example$event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[tags=test-topic-metadata]
----
...
.{sample-base-url}/event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[CounterIntegrationTest.java]
----
include::example$event-sourced-counter/src/it/java/counter/application/CounterIntegrationTest.java[tags=clear-topics]
----
...
[source,java]
.{sample-base-url}/event-sourced-counter/src/it/java/counter/application/CounterWithRealPubSubIntegrationTest.java[CounterWithRealPubSubIntegrationTest.java]
----
include::example$event-sourced-counter/src/it/java/counter/application/CounterWithRealPubSubIntegrationTest.java[tags=pubsub]
----
