...
As an example, we will use the https://github.com/lightbend/akka-javasdk/tree/main/samples/eventsourced-customer-registry[`customer-registry`] sample.
...
[source,xml,indent=0]
----
include::java:example$eventsourced-customer-registry-subscriber/pom.xml[tag=custom-port]
----
...
[source,command line]
----
curl localhost:9001/customers/by_name/Test%20Testsson
----
--
