...
.{sample-base-url}/eventsourced-counter/src/main/java/counter/application/CounterEntity.java[CounterEntity.java]
----
include::example$eventsourced-counter/src/main/java/counter/application/CounterEntity.java[tag=increaseWithError]
----
...
[source,java,indent=0]
.{sample-base-url}/eventsourced-counter/src/main/java/counter/api/CounterEndpoint.java[CounterEndpoint.java]
----
include::example$eventsourced-counter/src/main/java/counter/api/CounterEndpoint.java[tag=increaseWithError]
----
...
.{sample-base-url}/eventsourced-counter/src/main/java/counter/application/CounterEntity.java[CounterEntity.java]
----
include::example$eventsourced-counter/src/main/java/counter/application/CounterEntity.java[tag=increaseWithResult]
----
...
.{sample-base-url}/eventsourced-counter/src/main/java/counter/api/CounterEndpoint.java[CounterEndpoint.java]
----
include::example$eventsourced-counter/src/main/java/counter/api/CounterEndpoint.java[tag=increaseWithResult]
----
