...
You need to make the messages, events, or the state of Akka components serializable with https://github.com/FasterXML/jackson[Jackson]. The same is true for inputs and outputs of HTTP Endpoints. There are two ways to do this.

1. If you are using Java https://openjdk.org/jeps/395[record] then no annotation is needed. It just works. It's as simple as using `record` instead of `class`. Akka leverages https://github.com/FasterXML/[Jackson] under the hood and makes these records serializable for you.
...
----
include::example$eventsourced-customer-registry/src/main/java/customer/CustomerRegistrySetup.java[tag=object-mapper]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/main/java/customer/domain/CustomerEvent.java[tag=name-changed-old]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/CustomerEvent.java[tag=name-changed-new]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/NameChangedMigration.java[tag=name-changed-migration]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/CustomerEvent.java[tag=name-changed-with-migration]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/main/java/customer/domain/CustomerEvent.java[tag=address-changed-old]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/CustomerEvent.java[tag=address-changed-new]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/AddressChangedMigration.java[tag=address-changed-migration]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/CustomerEvent.java[tag=customer-created-old]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/main/java/customer/domain/CustomerEvent.java[tag=customer-created-new]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/main/java/customer/domain/CustomerCreatedMigration.java[tag=customer-created-migration]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/schemaevolution/AddressChangedMigration.java[tag=name-migration]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/CustomerEventSerializationTest.java[tag=testing-deserialization-encoding]
----
...
[source,java,indent=0]
----
include::example$eventsourced-customer-registry/src/test/java/customer/domain/CustomerEventSerializationTest.java[tag=testing-deserialization]
----
<1> Encodes old class in Base64 String.
