...
TIP: To learn more about Kalix entities see xref:java:value-entity.adoc[Implementing Key Value Entities] and xref:java:event-sourced-entities.adoc[Implementing Event Sourced Entities].
