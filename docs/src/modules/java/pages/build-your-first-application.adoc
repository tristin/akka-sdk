...
If you have already xref:akka-cli:installation.adoc[installed the Akka CLI], start the local console:
...
You can open the listed URL to see your local service in action:
