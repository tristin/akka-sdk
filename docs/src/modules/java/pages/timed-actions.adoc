...
* At most 50,000 active timers can be scheduled.
...
As said before, the `OrderEndpoint` will receive incoming messages, run some logic and then call the Order Entity as needed.
