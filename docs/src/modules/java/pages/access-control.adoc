...
overwritten in the project's pom file by defining a maven property named `akka.javasdk.dev-mode.service-name`.

[source,xml,ident=0]
----
<properties>
  <akka.javasdk.dev-mode.service-name>shopping-cart</akka.javasdk.dev-mode.service-name>
  ...
</properties>
----
