...
Views allow you to access multiple entities or retrieve entities by attributes other than their _entity id_. You can create Views for different access patterns, optimized by specific queries, or combine multiple queries into a single View.
