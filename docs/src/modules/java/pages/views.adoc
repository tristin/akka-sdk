...
[source,java]
.{sample-base-url}/event-sourced-customer-registry/src/main/java/customer/view/CustomerByNameView.class[CustomerByNameView.java]
----
...
[source,java,indent=0]
.{sample-base-url}/key-value-customer-registry/src/main/java/customer/view/CustomersResponseByCity.java[CustomersResponseByCity.java]
----
...
[source,java,indent=0]
.{sample-base-url}/key-value-customer-registry/src/main/java/customer/view/CustomersByCityIntegrationTest.java[CustomersByCityIntegrationTest.java]
----
