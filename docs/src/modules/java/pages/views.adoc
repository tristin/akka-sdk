...
You can access a single xref:reference:glossary.adoc#entity[Entity] with its xref:reference:glossary.adoc#entity-id[entity id] but oftentimes this is not enough. You might want to retrieve multiple Entities, or retrieve them using an attribute other than its id. xref:reference:glossary.adoc#view[Views] allow you to achieve this. You can create one View for each access pattern, so that it is optimized for a specific query, or combine multiple queries into a single View.
...
See also xref:concepts:development-process.adoc#_effects_api[Understanding what an Effect is]
...
.{sample-base-url}/customer-registry-views-quickstart/src/main/java/customer/domain/Customer.java[Customer.java]
----
include::example$customer-registry-views-quickstart/src/main/java/customer/domain/Customer.java[tags=class]
----
...
[source,java]
.{sample-base-url}/customer-registry-views-quickstart/src/main/java/customer/application/CustomerByEmailView.java[CustomerByEmailView.java]
----
include::example$customer-registry-views-quickstart/src/main/java/customer/application/CustomerByEmailView.java[tags=class]
----
...
[source,java]
----
include::example$customer-registry-views-quickstart/src/main/java/customer/application/CustomersByNameView.java[tag=row]
----
...
[source,java]
.{sample-base-url}/customer-registry-views-quickstart/src/main/java/customer/application/CustomersByNameView.java[CustomersByNameView.java]
----
include::example$customer-registry-views-quickstart/src/main/java/customer/application/CustomersByNameView.java[tags=class]
----
...
<3> Defines the query.
<4> Uses the new type `CustomerSummary` to return the result of the query.
...
[source,java,indent=0]
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/application/CustomerSummaryByName.java[CustomerSummaryByName.java]
----
include::example$valueentity-customer-registry/src/main/java/customer/application/CustomerSummaryByName.java[tag=delete]
----
...
[source,java]
.{sample-base-url}/eventsourced-customer-registry/src/main/java/customer/domain/CustomerEvent.java[CustomerEvent.java]
----
include::example$eventsourced-customer-registry/src/main/java/customer/domain/CustomerEvent.java[tags=class]
----
...
[source,java]
.{sample-base-url}/eventsourced-customer-registry/src/main/java/customer/view/CustomerByNameView.class[CustomerByNameView.java]
----
include::example$eventsourced-customer-registry/src/main/java/customer/application/CustomerByNameView.java[tags=class]
----
...
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/application/CustomerSummaryByName.java[CustomerSummaryByName.java]
----
include::example$valueentity-customer-registry/src/main/java/customer/application/CustomerSummaryByName.java[tag=projection]
----
...
[source,java]
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/application/CustomerList.java[CustomerList.java]
----
include::example$valueentity-customer-registry/src/main/java/customer/application/CustomerList.java[tag=class]
----

[source,java,indent=0]
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/application/CustomersResponseByName.java[CustomersResponseByName.java]
----
include::example$valueentity-customer-registry/src/main/java/customer/application/CustomersResponseByName.java[tag=class]
----
...
[source,java,indent=0]
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/view/CustomersResponseByCity.java[CustomersResponseByCity.java]
----
include::example$valueentity-customer-registry/src/main/java/customer/application/CustomersByCity.java[tag=view-test]
----

An integration test can be implemented as below.

[source,java,indent=0]
.{sample-base-url}/valueentity-customer-registry/src/main/java/customer/view/CustomersByCityIntegrationTest.java[CustomersByCityIntegrationTest.java]
----
include::example$valueentity-customer-registry/src/it/java/customer/application/CustomersByCityIntegrationTest.java[tag=view-test]
----
