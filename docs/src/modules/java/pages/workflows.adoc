...
<2> We instruct Akka to run a given asynchronous call, using the xref:component-and-service-calls.adoc#_component_client[ComponentClient], to withdraw funds from a wallet.
