...
:sample-url: https://github.com/lightbend/akka-javasdk/tree/main/samples/event-sourced-shopping-cart
...
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCart.java[tag=domain]
----
...
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCartEvent.java[tag=events]
----
...
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=class]
----
...
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=addItem]
----
...
.src/main/java/com/example/shoppingcart/domain/ShoppingCart.java
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCart.java[tag=itemAdded]
----
...
.src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=getCart]
----
...
----
include::example$event-sourced-shopping-cart/src/main/resources/application.conf[tag=snapshot-every]
----
...
.src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=checkout]
----
...
.src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java
----
include::example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=read-only]
----
...
[source,java]
----
include::example$event-sourced-shopping-cart/src/test/java/com/example/shoppingcart/domain/ShoppingCartTest.java[]
----
...
[source,java,indent=0]
----
include::example$event-sourced-shopping-cart/src/it/java/com/example/IntegrationTest.java[tag=sample-it]
----
