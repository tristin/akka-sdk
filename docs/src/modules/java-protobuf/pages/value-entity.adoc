...
An example integration test class to start from is also generated for you. It uses [.group-java]#an `TestkitExtension`# [.group-scala]#`TestKit`# to start docker containers and interacts with the entity with an actual gRPC client.
