...
[.group-java]
As an example, we will use the https://github.com/lightbend/kalix-jvm-sdk/tree/main/samples/protobuf-eventsourced-customer-registry[`customer-registry`] sample. 
...
[.group-java]
For that we will use two of our existing samples: https://github.com/lightbend/kalix-jvm-sdk/tree/main/samples/protobuf-eventsourced-customer-registry[`customer-registry`] and https://github.com/lightbend/kalix-jvm-sdk/tree/main/samples/protobuf-eventsourced-customer-registry-subscriber[`customer-registry-subscriber`].
...
[source, command line]
----
sbt -Dakka.javasdk.dev-mode.docker-compose-file=docker-compose-integration.yml runAll
----
--
