...
[source, command line]
----
mvn -Dakka.runtime.dev-mode.docker-compose-file=docker-compose-integration.yml kalix:runAll
----
--
...
[source, command line]
----
sbt -Dakka.runtime.dev-mode.docker-compose-file=docker-compose-integration.yml runAll
----
--
