...
In this sample we will make an action that does two sequential calls to the xref:value-entity.adoc[Key Value Entity Counter] service, deployed with the service name "counter."
