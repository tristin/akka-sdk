...
ifdef::todo[TODO:  For a full reference of all available commands, see the xref:reference:akka-cli/index.adoc[reference] page.]
[TIP]
====
...
akka auth -h
----
ifdef::todo[TODO:  You can also refer to the xref:reference:akka-cli/akka_auth.adoc[auth] page.]
=== Handling Proxies
...
ifdef::todo[TODO:  For more commands, see the xref:reference:akka-cli/akka_projects.adoc[projects] page.]
...
ifdef::todo[TODO:  For more details, see `akka docker -h` or visit xref:reference:akka-cli/akka_docker.adoc[docker] page.]
[NOTE]
====
For more information about using the Akka Container Registry (ACR) or external container registries, see xref:operations:projects/container-registries.adoc[].
====
...
Ensure you've set up your container registry credentials before deploying. For more details, see xref:operations:projects/container-registries.adoc[container registry] page.
...
ifdef::todo[TODO:  More information about this command in xref:reference:akka-cli/akka_services_components_list-events.adoc[components] page.]====
