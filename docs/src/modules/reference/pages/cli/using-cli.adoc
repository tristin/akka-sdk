...
ifdef::todo[TODO:  For a full reference of all available commands, see the xref:reference:cli/akka-cli/index.adoc[reference] page.]
[TIP]
====
...
For instructions on updating, see xref:reference:cli/installation.adoc[installing and updating].
====
