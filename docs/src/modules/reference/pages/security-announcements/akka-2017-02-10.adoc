...
To protect against such attacks the system should be updated to Akka _2.4.17_ or later and be configured with https://doc.akka.io/docs/akka/2.5/remoting.html#disable-java-serializer[disabled Java serializer].
