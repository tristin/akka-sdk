...
Restarts all service instances using the newest image.
...
NOTE: Configure Docker credentials to give Kalix permission to pull from a private image repository.
