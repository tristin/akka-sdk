...
The `akka organizations auth show _domain-id_` command shows detailed information about the given  authentication domain in the current (or specified) organization in Kalix.
