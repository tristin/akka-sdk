...
----
NOTE: Find detailed configuration instructions in the https://cloud.google.com/container-registry/docs/advanced-authentication#json-key[Google documentation {tab-icon}, window="new"].
