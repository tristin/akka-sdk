...
This filtering is known as  https://opentelemetry.io/docs/concepts/sampling/#head-sampling[head sampling, window="new"]. To configure it, you need to set your observability descriptor as follows:
