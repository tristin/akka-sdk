...
Once you have xref:operations:create-project.adoc[created an Akka project], use the Akka Console or the `akka` CLI to deploy a Service container images to the project.
