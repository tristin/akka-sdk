...
:TODO: We lack docs about building and pushing the container image! https://github.com/lightbend/kalix/issues/11832
...
. Open the https://console.akka.io[*Akka Console* {tab-icon}, window="new"].
...
Akka Console::
+
1. Open the https://console.akka.io[*Akka Console* {tab-icon}, window="new"].
2. Navigate to the *Project* where the Service is deployed.
3. Look for the *Service* card of the Service, it shows the status.
+
:TODO: image for service card image::console-service-card.png[Service card]
+
