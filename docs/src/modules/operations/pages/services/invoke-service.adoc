...
All traffic to Akka uses Transport Layer Security (TLS). Akka will automatically provision a certificate for you using https://letsencrypt.org/[Let's Encrypt, window="new"]. The certificate is provisioned whether you use a Akka provided hostname, or bring your own.
