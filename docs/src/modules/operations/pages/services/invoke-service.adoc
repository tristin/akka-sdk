...
You can now invoke your services using an HTTP client. TLS is not enabled. So for example, using `curl` to invoke your services from another terminal window:
