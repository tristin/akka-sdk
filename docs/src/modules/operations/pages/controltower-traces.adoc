...
Akka projects have the traces dashboard built-in as part of the Control Tower in the Akka Console. This is available out-of-the-box. You can find your traces here as long as you have xref:operations:observability-exports.adoc#_activating_tracing_beta[enabled the traces] in your service. 
