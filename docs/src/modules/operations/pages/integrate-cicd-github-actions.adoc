...
:page-aliases: projects:integrate-cicd-github-actions.adoc[]
...
These variables should be configured as https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository[secrets {tab-icon}, window="new"] for your repository.
...
The https://github.com/lightbend/akka-cicd-github-actions[lightbend/akka-cicd-github-actions] repository contains an example of a workflow that automatically builds, tests, and deploys a Node.js service to Akka.
...
To use the https://github.com/lightbend/akka-cicd-github-actions[lightbend/akka-cicd-github-actions] example, copy the workflow files and save the required variables as GitHub https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository[secrets {tab-icon}, window="new"]:

. Copy the workflow `.yml` files from the example repository https://github.com/lightbend/akka-cicd-github-actions/tree/main/.github/workflows[.github/workflows/ {tab-icon}, window="new"] directory into your project repository `.github/workflow` directory.
