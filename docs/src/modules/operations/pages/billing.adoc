...
For *billing-admin* users, a billing icon appears in the https://console.akka.io/[Akka Console's{tab-icon}, window="new"] side navigation. Clicking this icon opens the billing interface, where users can select the billing month and organization to view detailed billing data.
...
For more details on pricing, refer to https://akka.io/pricing#[Akka Pricing{tab-icon}, window="new"].
...
For more details on managing users and their roles, see the xref:manage-users.adoc[] section.

== See also

- xref:manage-users.adoc[]
- https://akka.io/pricing#[Akka Pricing{tab-icon}, window="new"]
