...
Message brokers are configured on the Akka project level. A project can have one broker configuration, Akka eventing is independent of the broker technology.
