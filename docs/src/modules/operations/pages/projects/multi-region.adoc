...
The default primary selection mode for stateful components is the static mode, as explained in <<_selecting_primary_for_stateful_components>>, and you might want to change that to dynamic after the first deployment. That section also describes how you change the primary selection mode with a service descriptor.
...
<<_selecting_primary_for_stateful_components>> describes how you change the primary selection mode with a service descriptor.
