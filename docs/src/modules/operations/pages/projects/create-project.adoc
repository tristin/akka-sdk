...
To create a new project, use either the Akka CLI or the https://console.akka.io[Akka Console {tab-icon}, window="new"]:

[.tabset]
--
CLI::
+
. If you haven't done so yet, xref:akka-cli:installation.adoc[install the Akka CLI] and log into your account:
+
...
UI::
+
. Log in to https://console.akka.io[Akka Console {tab-icon}, window="new"]
. Navigate to the https://console.akka.dev/projects[Projects {tab-icon}, window="new"] section.
...
- xref:reference:akka-cli/akka_projects_new.adoc#_see_also[`akka projects new` commands]
- xref:reference:akka-cli/akka_projects_get.adoc#_see_also[`akka projects get` commands]
