...
Access to projects is controlled by assigning specific roles to users. The available roles are: *admin*, *developer*, and *backoffice*.

[cols="1,1,1,1"]
|===
|Permission:                       |admin |developer |backoffice

|View project                      |✅     |✅        |✅
|Admin project                     |✅     |❌        |❌
|View, deploy, and update services |✅     |✅        |❌
|Delete services                   |✅     |❌        |❌
|Manage routes                     |✅     |✅        |❌
|Manage secrets                    |✅     |✅        |❌
...
- xref:reference:akka-cli/akka_roles.adoc#_see_also[`akka roles` commands]
