...
Akka allows exporting and importing data into and out of your services. This can be useful for the following use cases:
...
==== Create a Akka secret with the access key
