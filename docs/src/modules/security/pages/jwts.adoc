...
:page-aliases: services:using-jwts.adoc[], concepts:using-jwts.adoc[] 
...
If you don’t have a specific key that you want to use, you can let akka generate one for you:
...
Once you generated a token and provided it to your service, you still need to configure which endpoint requires such token. For more information on that, consult the respective "JWTs" sub-section under the SDK-specific xref:developing-services:index.adoc[] section.
