...
Once you generated a token and provided it to your service, you still need to configure which endpoint requires such token. For more information on that, consult xref:java:auth-with-jwts.adoc[].
