...
Users accounts in Akka may be protected with _multifactor authentication_ (MFA) for increased security. Organizations in Akka can require their members to set up MFA before joining the organization. For further details, please xref:support:email.adoc[contact our support team].

=== Audit logging for operating Akka services

Akka records all executed commands when operating services for audit logging purposes. For further details, please xref:support:email.adoc[contact our support team].
