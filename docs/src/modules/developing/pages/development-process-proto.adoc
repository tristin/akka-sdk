...
TIP: To learn more about Kalix entities see xref:java-protobuf:value-entity.adoc[Implementing Key Value Entities], xref:java-protobuf:event-sourced-entities.adoc[Implementing Event Sourced Entities], and xref:java-protobuf:replicated-entity.adoc[Implementing Replicated Entities].
...
A View provides a way to retrieve state from multiple Entities based on a query. You can create views from Key Value Entity state, Event Sourced Entity events, and by subscribing to topics. For more information about writing views see xref:java-protobuf:views.adoc[Implementing Views].

For more details and examples take a look at the following topics:

* xref:java-protobuf:value-entity.adoc[Key Value Entities]
