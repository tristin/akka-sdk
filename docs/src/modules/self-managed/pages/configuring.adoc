...
. podcost-crd.yml
+
For rolling updates in optimal order we need to define the PodCost CRD.
+
[source,yaml]
----
include::java:example$doc-snippets/standalone/podcost-crd.yml[]
----
...
kubectl apply -f podcost-crd.yml
