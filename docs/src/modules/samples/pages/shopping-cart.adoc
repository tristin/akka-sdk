...
----
include::java:example$shopping-cart-quickstart/src/main/java/shoppingcart/domain/ShoppingCart.java[]
----
...
----
include::java:example$shopping-cart-quickstart/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[]
----
// FIXME snippet anchors do not mach up
