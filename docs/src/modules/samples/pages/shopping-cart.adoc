...
include::java:partial$maven-archetype.adoc[]
...
----
include::java:example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCart.java[]
----
...
[source,java,indent=0]
.src/main/java/com/example/shoppingcart/api/ShoppingCartEntity.java
----
include::java:example$event-sourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=class]
----
