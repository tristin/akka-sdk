...
----
include::java:example$eventsourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCart.java[]
----
...
----
include::java:example$eventsourced-shopping-cart/src/main/java/com/example/shoppingcart/application/ShoppingCartEntity.java[tag=class]
----
