...
[source,command line]
----
curl -i -XPUT -H "Content-Type: application/json" localhost:8080/shopping-cart/123/item -d '
...
[source, command line]
----
curl localhost:8080/shopping-cart/123
----
...
[source, command line]
----
curl -i -XPOST localhost:8080/shopping-cart/123/checkout
----
