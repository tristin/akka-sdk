...
For an example of a choreography-based Saga, check out the https://github.com/lightbend/akka-javasdk/tree/main/samples/choreography-saga-quickstart[Akka Choreography Saga Quickstart].
