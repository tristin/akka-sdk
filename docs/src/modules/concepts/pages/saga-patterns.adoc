...
For an example of a choreography-based Saga, check out the Choreography Saga sample that can be downloaded as a link:../java/_attachments/choreography-saga-quickstart.zip[zip file].
