...
=== Service(s)
Services are the core unit of deployment in Akka. They equate to the concept of a microservice and contain all your components and objects as described in the Akka programming model xref:concepts:programming-model.adoc#_architecture[Architecture]. A project contains one or more services. Services can be started, stopped, and paused independently.
