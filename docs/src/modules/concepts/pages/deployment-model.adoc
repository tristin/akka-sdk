...
- Fully-automated regions on Akka Platform (at https://console.akka.io[akka.io], optionally running in your cloud infrastructure)
...
=== Fully-automated regions on Akka Platform
image:concepts:deployment-model_akka-platform.png[Deployment model: Akka Platform]
...
=== Self-managed nodes
image:concepts:deployment-model_self-managed.png[Deployment model: self-managed nodes]
