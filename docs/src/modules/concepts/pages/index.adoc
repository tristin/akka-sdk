...
Akka manages the operational aspects of your application. To learn about how Akka Services run in distributed infrastructure and may span multiple _Regions_, see xref:deployment-model.adoc[Deployment Model]. Once deployed, Akka's xref:control-tower.adoc[Telemetry and Monitoring] provides operational insights into your deployment.
