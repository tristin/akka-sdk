...
[#_create_a_project]
== Create a project
All services and applications start as a Java project. Akka has a Maven archetype and plugin that makes this easier. You will code your service in this project. See xref:java:build-your-first-application.adoc#[] for more details.
