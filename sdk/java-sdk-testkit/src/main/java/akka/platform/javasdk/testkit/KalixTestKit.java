...
import akka.platform.javasdk.impl.GrpcClients;
...
import static akka.platform.javasdk.testkit.KalixTestKit.Settings.EventingSupport.TEST_BROKER;
...
public class KalixTestKit {
  ...
  /**
   * Returns {@link akka.platform.javasdk.testkit.EventingTestKit.MessageBuilder} utility
   * to create {@link akka.platform.javasdk.testkit.EventingTestKit.Message}s for the eventing testkit.
   */
