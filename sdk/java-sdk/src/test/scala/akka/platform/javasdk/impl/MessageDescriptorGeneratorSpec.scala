...
import akka.platform.spring.testmodels.NestedMessage
import akka.platform.spring.testmodels.SimpleMessage
import akka.platform.spring.testmodels.TimeEnum
