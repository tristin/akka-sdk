...
import akka.platform.spring.testmodels.EndpointsTestModels.GetHelloEndpoint
import akka.platform.spring.testmodels.EndpointsTestModels.DeleteHelloEndpoint
import akka.platform.spring.testmodels.EndpointsTestModels.PatchHelloEndpoint
import akka.platform.spring.testmodels.EndpointsTestModels.PostHelloEndpoint
import akka.platform.spring.testmodels.EndpointsTestModels.PutHelloEndpoint
