...
import akka.platform.javasdk.impl.http.PathTree.JavaMethodInvoker
import akka.platform.javasdk.impl.http.PathTree.OpenPathTree
import akka.platform.spring.testmodels.EndpointsTestModels
import akka.platform.spring.testmodels.EndpointsTestModels.FooBar
import akka.platform.spring.testmodels.EndpointsTestModels.FooBarBaz
import akka.platform.spring.testmodels.EndpointsTestModels.FooBarBazWithInt
import akka.platform.spring.testmodels.EndpointsTestModels.FooTrailingSlashes
import akka.platform.spring.testmodels.EndpointsTestModels.FooWithDoubleMapping1
import akka.platform.spring.testmodels.EndpointsTestModels.FooWithDoubleMapping2
import akka.platform.spring.testmodels.EndpointsTestModels.TestBoolean
import akka.platform.spring.testmodels.EndpointsTestModels.TestChar
import akka.platform.spring.testmodels.EndpointsTestModels.TestDouble
import akka.platform.spring.testmodels.EndpointsTestModels.TestFloat
import akka.platform.spring.testmodels.EndpointsTestModels.TestFloatDouble
import akka.platform.spring.testmodels.EndpointsTestModels.TestInt
import akka.platform.spring.testmodels.EndpointsTestModels.TestLong
import akka.platform.spring.testmodels.EndpointsTestModels.TestMultiVar
import akka.platform.spring.testmodels.EndpointsTestModels.TestShort
import akka.platform.spring.testmodels.EndpointsTestModels.TestShortIntLong
import akka.platform.spring.testmodels.EndpointsTestModels.TestString
import akka.platform.spring.testmodels.EndpointsTestModels.TestUnsupportedType
