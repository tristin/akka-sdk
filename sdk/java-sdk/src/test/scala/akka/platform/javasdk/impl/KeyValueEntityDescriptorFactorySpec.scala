...
import akka.platform.spring.testmodels.keyvalueentity.ValueEntitiesTestModels.InvalidValueEntityWithOverloadedCommandHandler
import akka.platform.spring.testmodels.keyvalueentity.ValueEntitiesTestModels.ValueEntityWithMethodLevelAcl
import akka.platform.spring.testmodels.keyvalueentity.ValueEntitiesTestModels.ValueEntityWithMethodLevelJwt
import akka.platform.spring.testmodels.keyvalueentity.ValueEntitiesTestModels.ValueEntityWithServiceLevelAcl
import akka.platform.spring.testmodels.keyvalueentity.ValueEntitiesTestModels.ValueEntityWithServiceLevelJwt
...
class KeyValueEntityDescriptorFactorySpec extends AnyWordSpec with ComponentDescriptorSuite {
  ...
  "ValueEntity descriptor factory" should {
    ...
    "generate mappings for a Key Value Entity" in {
