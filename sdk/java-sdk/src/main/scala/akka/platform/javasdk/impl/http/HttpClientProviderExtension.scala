...
import akka.platform.devtools.impl.DevModeSettings
import akka.platform.devtools.impl.HostAndPort
 ...
 */
@InternalApi
private[akka] object HttpClientProviderExtension
 ...
 */
@InternalApi
private[akka] class HttpClientProviderExtension(system: ExtendedActorSystem) extends Extension with HttpClientProvider {
