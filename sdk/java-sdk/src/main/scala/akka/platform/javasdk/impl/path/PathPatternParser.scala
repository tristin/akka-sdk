...
package akka.platform.javasdk.impl.path
...
import akka.platform.javasdk.impl.path.PathPatternParser.Literal
import akka.platform.javasdk.impl.path.PathPatternParser.Segment
