...
import akka.platform.javasdk.impl.telemetry.ValueEntityCategory
import akka.platform.javasdk.impl.valueentity.ValueEntityEffectImpl.DeleteEntity
import akka.platform.javasdk.valueentity.CommandContext
...
import akka.platform.javasdk.impl.valueentity.ValueEntityEffectImpl.UpdateState
import akka.platform.javasdk.impl.valueentity.ValueEntityRouter.CommandResult
...
private[akka] final class ValueEntityContextImpl(override val entityId: String, system: ActorSystem)
    extends AbstractContext(system)
